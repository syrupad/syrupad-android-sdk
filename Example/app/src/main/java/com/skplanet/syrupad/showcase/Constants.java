...
public final class Constants {
    ...
    public final class AdTypes {
        ...
        public static final String SLOT7 = "[Slot 7]";
    }
    ...
    public static class AdSample {
        ...
        private AdSample(String type, int icon, String size, String clientId, int slot, boolean isXml) {
            this.type = type;
            this.icon = icon;
            this.size = size;
    ...
    static AdSample[] AD_SAMPLES = new AdSample[]{
            ...
            new AdSample("Standard Banner (XML)", R.drawable.banner, AdTypes.SLOT2, "AXT002001", AdSlot.BANNER, true),
            ...
            new AdSample("Native", R.drawable.video, AdTypes.SLOT7, "AXT007001", AdSlot.NATIVE, false),
